...
@section('content')
    ...
    @if (\Illuminate\Support\Facades\Session::has('add-to-cart-success'))
        <div class="col-12 alert alert-success alert-block">
            <button type="button" class="close" data-dismiss="alert">×</button>
            <strong>{{ \Illuminate\Support\Facades\Session::get('add-to-cart-success') }}</strong>
        </div>
                ...
                <div class="product-grid">
                    <div class="product-image">
                        ...
                        <ul class="social">
                            ...
                            <li><a href="{{route('add-to-cart',$product->id)}}" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                        </ul>
